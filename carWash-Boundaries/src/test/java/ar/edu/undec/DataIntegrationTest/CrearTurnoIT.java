...
public class CrearTurnoIT {
    ...
    @Test
    public void guardarTurno_TurnoGuardado_devuelveTrue() throws TurnoIncompletoException, VehiculoIncompletoException, EmpleadoIncompletoException {
        Vehiculo elVehiculo = Vehiculo.factoryVehiculo(1, "NRP374", "Toyota", "2016");
