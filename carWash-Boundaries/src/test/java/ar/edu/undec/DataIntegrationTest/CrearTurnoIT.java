...
public class CrearTurnoIT {
    ...
    public void guardarTurno_TurnoGuardado_devuelveTrue() throws TurnoIncompletoException, VehiculoIncompletoException, EmpleadoIncompletoException, ClienteIncompletoException {
        Cliente elCliente = Cliente.factoryCliente(2,"Pepe Salinas","Porahi 256","Los guapes 123","1234567");
        Vehiculo elVehiculo = Vehiculo.factoryVehiculo(2, "NRP374", "Toyota", "2016", elCliente);
        Empleado elEmpleado = Empleado.factoryEmpleado(2, "Pedro Anderson", 0303456);
        Turno elTurno = Turno.factoryTurno(2,elVehiculo, LocalDate.of(2019,11,13), elEmpleado,750);
